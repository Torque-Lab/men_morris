...
export function GameBoard({
  ...
  return (
    <div className="w-[150px] h-[150px] mx-auto flex-shrink-0 mb-1">
      <svg 
        viewBox="0 0 100 100" 
      ...
      >
        {/* Board lines */}
        <rect x="10" y="10" width="80" height="80" stroke="#222" strokeWidth="1" fill="none" />
        <rect x="20" y="20" width="60" height="60" stroke="#222" strokeWidth="1" fill="none" />
        <rect x="30" y="30" width="40" height="40" stroke="#222" strokeWidth="1" fill="none" />
        ...
        {POSITIONS.map((pos: Position) => {
          ...
          const isOpponentPiece = board[pos.id] === (board[pos.id] === 'white' ? 'black' : 'white');
            ...
            <g key={pos.id}>
              <circle
                ...
                style={{
                  ...
                  transition: 'all 0.2s',
                  opacity: removalMode && isOpponentPiece && !isValidRemoval ? 0.3 : 1
                }}
